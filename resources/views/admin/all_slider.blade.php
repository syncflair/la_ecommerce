...
@section('title', 'All slider | Laravel')
...
<a href="{{URL::to('/add-slider')}}" class="btn btn-primary">Add slider</a>
	...
	<div class="box span12">
		...
		<div class="box-content">
			<table class="table table-striped table-bordered bootstrap-datatable datatable">
			  ...
			  @foreach( $all_slider_info_view as $v_slider)

			   	<tbody>	
					<tr>
						<td>{{ $v_slider->slider_id }}</td>
						<td class="center">{{ $v_slider->slider_name }}</td>
						<td class="center"><img style="width:100px; height:100px; " src="{{ $v_slider->slider_image }}"></td>
						...
						<td class="center">
							@if($v_slider->slider_status == 1)
								<a class="btn btn-danger" title="Click to Unactive" href="{{URL::to('/unactive-slider/'.$v_slider->slider_id)}}">								
									<i class="halflings-icon white thumbs-down"></i>
								</a>
							@else
								<a class="btn btn-success" title="Click to Active" href="{{URL::to('/active-slider/'.$v_slider->slider_id)}}">								

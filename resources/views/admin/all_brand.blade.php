...
@section('title', 'All Brand | Laravel')
	...
	<div class="box span12">
		...
		<div class="box-content">
			<table class="table table-striped table-bordered bootstrap-datatable datatable">
			  ...
			  @foreach( $all_brand_info_view as $v_brand)

			   	<tbody>	
					<tr>
						<td>{{ $v_brand->brand_id }}</td>
						<td class="center">{{ $v_brand->brand_name }}</td>
						<td class="center">{{ $v_brand->brand_desc }}</td>
						...
						<td class="center">
							@if($v_brand->pub_status == 1)
								<a class="btn btn-danger" title="Click to Unactive" href="{{URL::to('/unactive-brand/'.$v_brand->brand_id)}}">								
									<i class="halflings-icon white thumbs-down"></i>
								</a>
							@else
								<a class="btn btn-success" title="Click to Active" href="{{URL::to('/active-brand/'.$v_brand->brand_id)}}">								
							...
							<a class="btn btn-danger" id="delete" href="{{URL::to('/delete-brand/'.$v_brand->brand_id)}}">

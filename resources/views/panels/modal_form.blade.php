      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal" method="post" enctype="multipart/form-data">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control" name="contact_phone"  placeholder="Contact name">
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="checkbox" id="contact_status" class="form-control" name="contact_status" value="">
		    </div>
		  </div>

	...
	<section id="cart_items">
		<div class="container">
			...
			<div class="register-req">
				<p>Please fill up bellow from</p>
			</div><!--/register-req-->
				...
				<div class="row">
					...
					<div class="col-sm-12 clearfix">
						<div class="bill-to">
							...
							<div class="form-one">
								<form action="{{url('/add-shipping-address')}}" method="post">
									{{csrf_field()}}
									<input type="hidden" name="customer_id" value="{{ Session::get('customer_id') }}">
									<input type="text" placeholder="Name" name="ship_name">
									...
									<input type="text" placeholder="Mobile Phone" name="ship_mobile_phone">
									...
									<input type="submit" placeholder="Go next" class="btn btn-primary">
								</form>
							</div>
